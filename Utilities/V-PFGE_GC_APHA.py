...
from Bio.Restriction import EcoRI, BamHI, HindIII, EagI, SacII, SmaI, KniI, XhoI, ApaI, NarI, ClaI# Import additional enzymes here
...
available_enzymes = [EcoRI, BamHI, HindIII, EagI, SacII, SmaI, KniI, XhoI, ApaI, NarI, ClaI]  # Add more enzymes to the list as needed
